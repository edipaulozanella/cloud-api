...
exports.is_token = function (token) {
  //exports.is_token = function (token, retorno) {
  try {
...
exports.make_token = function (obj) {
...
exports.get_token_user = function (req) {
  if (req.headers && req.headers.token_user) {
...
exports.conteString = function (string, key) {
  if (!string || !key) {
    return false;
  }
  try {
